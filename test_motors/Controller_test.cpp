/**********************************************
 * 
 * This programs excutes the 4 motor drive using RT threads
 * 
 * 
 * ********************************************/
...
void *Motors_thread_func(void *data)
{
    ...
    double BWS_frequency_test = 0.3f;  //Hz
    /* local variables for chasis controller */
    ...
    while(run_flag){
        ...
        /*********************** record something if U want ***********************/
        OutFileAngle << reference_angular_pos[0] << "," <<  reference_angular_pos[1] << "\n";
